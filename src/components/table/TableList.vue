      ...
      >
        <template slot-scope="scope">
          ...
          <div v-if="item.formatData">
            <div v-if="item.tag">
              <el-tag size="mini" v-for="tag in item.formatData(scope.row[item.prop])" :type="tag.type" :key="tag.name">
                {{ tag.name }}
              </el-tag>
            </div>
            ...
            <div v-else>
              <span>{{ item.formatData(scope.row[item.prop]) || scope.row[item.prop] }}</span>
            </div>
          </div>
        </template>
      </el-table-column>
